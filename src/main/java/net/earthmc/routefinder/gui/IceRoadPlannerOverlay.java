...
public final class IceRoadPlannerOverlay {
  ...
  public static void renderUi(GuiGraphicsExtractor g,int sw,int sh){
  ...
  private static void renderScaledUi(GuiGraphicsExtractor g,int sw,int sh){
    if(!active)return;
  ...
  private static void choosePlacementY(Runnable after){
    ...
    mc.gui.setScreen(new CoordinatesScreen(mc.gui.screen(),"Choose Y before placing points","0",
  ...
  private static void addCoordinates(){
    var mc=Minecraft.getInstance();
    mc.gui.setScreen(new CoordinatesScreen(mc.gui.screen(),"Place at X / Y / Z",coordinateX,
  ...
  private static void editCoordinates(boolean marker){
    ...
    mc.gui.setScreen(new CoordinatesScreen(mc.gui.screen(),marker?"Edit marker X / Y / Z":"Edit point X / Y / Z",
  ...
  public static boolean click(double mx, double my, double worldX, double worldZ, int sw) {
    ...
    if (clickPlannerUi(mx, my, sw)) {
      ...
      uiPressHandled = !(Minecraft.getInstance().gui.screen() instanceof CoordinatesScreen);
      return true;
    }
