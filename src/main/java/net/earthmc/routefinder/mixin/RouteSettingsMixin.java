...
public abstract class RouteSettingsMixin {
    ...
    private void routefinder$settings(CallbackInfo ci){
        ...
        action("Accessibility saves",()->mc.gui.setScreen(new AccessibilitySavesScreen(parent)));
        action("Ice road settings",()->mc.gui.setScreen(new IceRoadSettingsScreen(parent)));
        relayout();
    }
}
